  ...
  return (
    <>
      <section id="about" className="about-section mb-40">
        ...
        <div className="text-secondary text-lg grid grid-cols-aboutGrid mt-8 gap-x-7">
          <div className="flex flex-col gap-y-4">
            ...
            <div>
              I also recently started bloggin on{" "}
              <a
                className="fun-underline"
                href="https://www.medium.com/@bryanyi"
              >
                Medium
              </a>{" "}
